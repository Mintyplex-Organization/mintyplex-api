...
func (uc *AuthServiceImpl) SignUpUser(user *models.SignUpUser) (*models.UserResponse, error) {
...
func (uc *AuthServiceImpl) SignInUser(*models.SignInInput) (*models.UserResponse, error) {
	return nil, nil
}
